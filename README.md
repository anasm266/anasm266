...
- Active TypeScript ESLint PRs: [#12280](https://github.com/typescript-eslint/typescript-eslint/pull/12280) is awaiting review, and [#12281](https://github.com/typescript-eslint/typescript-eslint/pull/12281) has requested changes.
- Merged [refined-github](https://github.com/refined-github/refined-github/pull/9280) PR restoring `esc-to-cancel` behavior on pull requests.
