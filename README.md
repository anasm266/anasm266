...
| --- | --- | --- |
| [any-map](https://github.com/anasm266/any-map) | Static flow analysis for TypeScript `any` types. Ranks the sources causing the most type erosion and traces how they spread through a codebase. | TypeScript, Compiler API, CLI, npm |
